...
export class Init1753388681271 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "bosses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, CONSTRAINT "PK_e1211266746c0f77ea58fc4c743" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_51682233e12c4973d883e349181" FOREIGN KEY ("boss_id") REFERENCES "bosses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
